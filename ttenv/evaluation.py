...
if __name__ == '__main__':
    ...
    if task != "non-markovian":
        adfq_dirs = [os.path.join(file_dir, "TargetTracking-v1_1_11042029/seed_0/test/seed_" + str(seed) + "/" + (
            "random_init/" if random_init else "")) for seed in seeds]
        dqn_dirs = [os.path.join(file_dir, "TargetTracking-v1_1_11042029/seed_0/test/seed_" + str(seed) + "/" + (
            "random_init/" if random_init else "")) for seed in seeds]
        pfdqn_dirs = [os.path.join(file_dir, "TargetTracking-v1_1_11041602/seed_0/test/seed_" + str(seed) + "/" + (
            "random_init/" if random_init else "")) for seed in seeds]
        mc_dirs = [os.path.join(file_dir, "TargetTracking-v1_1_11042029/seed_0/test/seed_" + str(seed) + "/" + (
            "random_init/" if random_init else "")) for seed in seeds]
        mc_greedy_dirs = [os.path.join(file_dir, "TargetTracking-v1_1_11042029/seed_0/test/seed_" + str(seed) + "/" + (
            "random_init/" if random_init else "")) for seed in seeds]
