...
def evaluation_ttenv(act, env_id,num_targets, eval_type='random', nb_itrs=5, render=False, **kwargs):
    """
    ...
    # todo
    env = ttenv.make(env_id, 'target_tracking', render=render, is_training=False, **kwargs)
