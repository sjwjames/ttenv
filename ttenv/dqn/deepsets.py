# code from https://github.com/manzilzaheer/DeepSets/tree/master/PointClouds implemented for permutation-equivariant
...
class D(nn.Module):
    ...
    def __init__(self, d_dim, x_dim=3, pool='mean',output_dim=12):
